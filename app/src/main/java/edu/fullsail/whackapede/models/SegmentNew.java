...
public class SegmentNew {
    private SegmentNew head = null;
    private SegmentNew tail = null;
    ...
    public SegmentNew( float currentXPercent, float currentYPercent, float radiusPercent ) {
    ...
    public void setHead( SegmentNew segmentNew ) {
        head = segmentNew;
    }

    public SegmentNew getHead() {
        return head;
    }

    public void setTail( SegmentNew segmentNew ) {
        tail = segmentNew;
    }

    public SegmentNew getTail() {
        return tail;
    }
